...
class Student{
	...
	void setName(String fName, String lName) throws ValidationException {
		...
		if (!(java.lang.Character.isUpperCase(fName.charAt(0)))&&(java.lang.Character.isUpperCase(lName.charAt(0)))){
	...
	public int hashCode() { 
		...
		int hash = (int)cgpa + fName.hashCode() + lName.hashCode() + num;
		return hash%1000 +1;
	}
...
public class QP2_2019A7PS0052P {
	...
	static void writeRecords(List<Student> sortedList) {
		...
		try {
			out  = new PrintWriter(new FileOutputStream("QP2_2019A7PS0052P.txt"));
		} catch (FileNotFoundException e) {
	...
	public static void main(String args[]) {
		...
		**********************************************************************************/
		 ...
		 *********************************************************************************************************************************/
		search_dept = in.nextLine();
		sortByDept(hm, search_dept);
